...
window.onload = function() {
    ...
    if(userLnameValue === ''){
        setErrorFor (userLname, 'Can not skip username')
    } else {
        setSuccessFor (userLname);
    }
    if(userTelValue === ''){
        setErrorFor (userTel, 'Can not skip username')
    } else {
        setSuccessFor (userTel);
    }
    if(userEmailValue === ''){
        setErrorFor (userEmail, 'Can not skip username')
    } else {
        setSuccessFor (userEmail);
    }
    if(userBirthValue === ''){
        setErrorFor (userBirth, 'Can not skip username')
    } else {
