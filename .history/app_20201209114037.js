window.onload = function() {
    ...
    function generateContactList() {
        ...
        contactsList.forEach((contact) => {
            const { id, name, lastName, phone, mail } = contact;
            ...
            const mailList = document.createElement('p');
            mailList.innerText = mail;
            // phonesList.innerText = phones.join(' ');
            phonesList.innerText = phone;
            container.appendChild(title);
            container.appendChild(phonesList);
            container.appendChild(mailList);
