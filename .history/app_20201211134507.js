...
window.onload = function() {
    ...
    function generateContactList() {
        ...
        contactsList.forEach((contact) => {
            ...
            const removeAllContacts = document.getElementById('clearBookBtn');
            removeAllContacts.addEventListener('mousedown',function (e) {
                e.preventDefault();
            })

            removeAllContacts.addEventListener('click', function (e) {
                console.log(e);
